...
// certainties
export const CAP_CERTAINTY_OBSERVED = 'Observed';
export const CAP_CERTAINTY_LIKELY = 'Likely';
export const CAP_CERTAINTY_POSSIBLE = 'Possible';
export const CAP_CERTAINTY_UNLIKELY = 'Unlikely';
export const CAP_CERTAINTY_UNKNOWN = 'Unknown';
export const CAP_CERTAINTIES = getStringSet('CAP_CERTAINTIES', [
  CAP_DEFAULT_CERTAINTY,
